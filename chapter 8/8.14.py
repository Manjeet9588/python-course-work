...
other name-value pairs, such as a color or an optional feature. Your function should 
work for a call like this one: car = make_car('subaru', 'outback', color='blue', 
tow_package=True) Print the dictionary that’s returned to make sure all the information 
was stored correctly.'''

def make_car(Manufacture, Model_name, **other):
    other['Manufacture'] = Manufacture.title()
    other['Model name'] = Model_name.title()
    return other
